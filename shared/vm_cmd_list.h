...
#define VM_CMD_LIST CONV_TYPE(none, 1),                                                                           \
                    ...
                    CONV_TYPE(EQ, 1),                                                                             \
                    CONV_TYPE(NE, 1),                                                                             \
                    CONV_TYPE(INIT_bVAR, BITS_TO_BYTES(VARS_ADDR_BITS) + 1 + 1), /**/                             \
                    CONV_TYPE(INIT_gVAR, BITS_TO_BYTES(VARS_ADDR_BITS) + 1 + 1), /**/                             \
                    ...
                    CONV_TYPE(PUSH_PNT, BITS_TO_BYTES(VARS_ADDR_BITS) + 1 + 1),  /*OP, pointer, type of pointer*/ \
